...
- [ ] T032 [US1] Verify SC-005 sequencing: confirm in PR commentary that the SP-003 (ingest) spec PR is NOT opened until the terminal D-NNN entry from T029/T030/T031 is committed to `main`. If SP-003 scaffolding is attempted before the binary exit closes, CI rejects the SP-003 PR with a clear pointer to ADR-010 §Sequencing. *Prereqs: T029 OR T030 OR T031. SC-005; pilot-harness.feature scenario "SP-003 (ingest) is blocked until binary exit closes"*
